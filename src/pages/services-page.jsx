import {
  ...
  CreditCard,
  FlaskRound,
   Wrench,       // Custom-fit systems
  Zap,          // Fast turnaround
  Layers,       // Built to scale
  Target,       // Research-backed, results-driven
} from "lucide-react";
    ...
    return (
        <div className="section">
            ...
            <div className="grid grid-cols-4 gap-8">
                {
                    benefits.map((benefit, i) => (
                        <div className="flex-center-all !flex-col text-center gap-4 mt-8 max-w-[300px] shadow-lg p-4 rounded-xl" key={`benefit-${i}`}>
            ...
            <p className="text-gray-800 mt-8">
                Whether you are launching something new or fine-tuning the engine — we are your team behind the scenes.
            </p>
        </div>
    )
}
...
const OurCoreServices = () => {
    ...
    const services = [
  {
    ...
    bestFor: "Startups, SMEs, personal brands, corporate websites, service providers",
    useCases: "Business websites, eCommerce, custom portals, CMS, landing pages",
    icon: Code,
  },
  {
    ...
    bestFor: "Tech startups, SaaS companies, large teams managing live platforms",
    useCases: "CI/CD pipelines, cloud deployment, system monitoring, infrastructure-as-code",
    icon: CloudCog,
  },
  {
    ...
    useCases: "Tech support, network setup, software integration, endpoint management",
    icon: Server,
  },
  {
    ...
    return (
        <div className="section">
            <div className="text-center max-w-lg">
                <p className="text-lg font-semibold uppercase text-base-color mb-4">Our Core Services</p>
            ...
            <div className="grid grid-cols-3 gap-14 mt-14 ">
                {
                    services.map((service, i) => (
                        <div className="w-[370px] min-h-[300px] p-10 flex-col pb-8 bg-base-color text-white shadow-xl rounded-2xl" key={`service-card-${i}`}>
  ...
  return (
    <div className="h-[40vh] w-full relative text-white">
      ...
      <div className="w-full h-full p-10 flex-center-all gap-10">
        <div className="">
          <h3 className="mb-3 text-base-color bg-white p-2 w-fit uppercase">OUR SERVICES</h3>
          <h1 className="text-5xl">Smarter Services. Seamless Growth.</h1>
        </div>

        <p className="text-sm max-w-2xl text-gray-200">
          At Barsmiko, we deliver the behind-the-scenes tech that moves your business forward — with less friction and more precision. Whether you’re building from scratch or optimizing what already works, our systems are crafted to support scale, sustainability, and speed.
        </p>
      </div>
    </div>
  );
