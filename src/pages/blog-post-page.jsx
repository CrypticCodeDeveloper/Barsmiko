           ...
           <div className='max-w-4xl'>
            ...
            <div className="mt-4 flex flex-col md:items-center md:flex-row gap-4">
                <div className="flex-center-y gap-2">
                  ...
                  <AvatarImage src="" />
                  <AvatarFallback className="bg-base-color text-white font-semibold uppercase">{blog.author.username[0]}</AvatarFallback>
                </Avatar>
                <p>{blog.author.username}</p>
                </div>
                <p className="font-semibold">{new Date(blog.createdAt).toUTCString()}</p>
